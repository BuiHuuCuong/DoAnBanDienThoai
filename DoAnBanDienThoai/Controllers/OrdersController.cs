...
namespace DoAnBanDienThoai.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var doAnBanDienThoaiContext = _context.Order.Include(o => o.CartItem).Include(o => o.User);
        ...
        public async Task<IActionResult> Create([Bind("OrderID,UserID,CartItemId,Email,Address,Phone,Total,OrderDate")] Order order)
        {
